...
type UserInfo struct {
	...
	Images    []map[string]interface{} `gorm:"column:images;NOT NULL;type:json" form:"images" json:"images"`
	Videos    []map[string]interface{} `gorm:"column:videos;NOT NULL;type:json" form:"videos" json:"videos"`
}
